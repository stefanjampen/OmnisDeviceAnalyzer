...
/**
 * Class copied form internet: "https://github.com/MobiDevelop/android-split-pane-layout"
 * "An Android layout which splits the available space between two child views.
...
public class SplitPaneLayout extends ViewGroup {
    ...
    private void extractAttributes(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mOrientation = 1; // a.getInt(R.styleable.SplitPaneLayout_orientation, 0);
